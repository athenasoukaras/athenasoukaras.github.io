...
var descriptions = ["This app was created for our final hackathon! Me and my partner, Annalisa, decided to create a dress-up app for our project!", "One of our first projects for Mr. King's class was the game project! Me and Jayna buth created <a href='https://afterthebell.github.io' target='_blank'>After The Bell</a> for the project, which was centered around the topic of bullying!","This project was created for AP Computer Science Principles! We had to use three variables and if-statements to create a decision-maker app.", "This was one of the first projects for Computer Science Principles! Me and Nyson created an app to inform the user about the mobile rhythm game, Project Sekai:Colorful Stage."];
var index = 0;
